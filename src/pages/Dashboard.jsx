        ...
        <div className="min-h-screen bg-base-200 pt-20 mx-2">
            ...
            <section className="grid  grid-cols-1 lg:grid-cols-3 gap-6 my-6">
...

                {
                    states.map(state => {
                        return (
                            <div key={state} className="bg-base-300 rounded-lg p-6 space-y-4">
                                <h3 className="font-bold text-xl text-neutral">{state}</h3>

                                {
                                    tasks?.map(task => {
                                        if (task.state === state) {
                                            return (
                                                <div key={task?._id} className="bg-gray-50 rounded-md overflow-hidden group">
